angular.module('starter.controllers-account', ['ionic.service.core'])
  ...
  */
  ...
  function loadProfileData() {
    ...
    if($scope.AuthData.hasOwnProperty('uid')){
	  ...
	  // save the tokens to the firebase app
...
var authSuccess = function(user) {
  ...
  "debug": true 
	...
	var callback = function(token) {
			...
			var fireurl = "https://burning-torch-4984.firebaseio.com/users/"+ $scope.AuthData.uid   + "/";
		
		var usersRef = new Firebase(fireurl);
		


usersRef.child("meta").update({
